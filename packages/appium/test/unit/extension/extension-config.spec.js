    ...
    describe('displayConfigWarnings()', function () {
      ...
      describe('when the extension data is missing an `installSpec` field', function () {
        ...
        it('should log a warning', async function () {
          ...
          expect(
            MockAppiumSupport.logger.getLogger().warn,
          ).to.have.been.calledWith(
            'Driver "derp" has an invalid or missing `installSpec` property in `extensions.yaml`; this may cause upgrades done via the `appium` CLI to fail.',
          );
        });
      });
      ...
      describe('when the extension data is missing an `installType` field', function () {
        ...
        it('should log a warning', async function () {
          ...
          expect(
            ...
            'Driver "derp" has an invalid or missing `installType` property in `extensions.yaml`; this may cause upgrades done via the `appium` CLI to fail.',
          );
        });
      });
      ...
      describe('when the extension data is missing an `appiumVersion` field', function () {
        ...
        it('should log a warning', async function () {
          ...
          expect(
            ...
            `Driver "derp" may be incompatible with the current version of Appium (v${APPIUM_VER}) due to an invalid or missing peer dependency on Appium. Please ask the developer of "derp" to update the peer dependency!`,
          );
        });
      });
      ...
      describe('when the extension data has an `appiumVersion` field which does not satisfy the current version of Appium, and an upgrade is available', function () {
        ...
        it('should log a warning', async function () {
          ...
          expect(
            ...
            `Driver "derp" may be incompatible with the current version of Appium (v${APPIUM_VER}) due to its peer dependency on Appium v${extData.appiumVersion}. Please upgrade "derp" to v1.1.0 or (potentially unsafe) v2.0.0.`,
          );
        });
      });
      ...
      describe('when the extension data has an `appiumVersion` field which does not satisfy the current version of Appium, and no upgrade is available', function () {
        ...
        it('should log a warning', async function () {
          ...
          expect(
            ...
            `Driver "derp" may be incompatible with the current version of Appium (v${APPIUM_VER}) due to its peer dependency on Appium v${extData.appiumVersion}. Please ask the developer of "derp" to update the peer dependency!`,
          );
        });
      });
    });
