 ...
 * @param {import('@appium/types').DriverClass} DriverClass
 * @param {import('@appium/types').AppiumW3CCapabilities} [defaultCaps]
 */

export function baseDriverUnitTests(DriverClass, defaultCaps = {}) {
  ...
  describe(`BaseDriver unit suite (as ${className})`, function () {
    ...
    it('should not be able to start two sessions without closing the first', async function () {
      ...
      await d
        .createSession(_.cloneDeep(w3cCaps))
